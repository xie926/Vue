    ...
    <div class="score-container">
      ...
      <div class="ratings-right">
        <div class="ratings-right__top">
          ...
          <div class="star">
            <span
              v-for="(star, index) in stars.serviceScore"
              :key="index"
              class="star-item"
              :class="star"
            >★</span>
        ...
        <div class="ratings-right__middle">
          ...
          <div class="star">
            <span
              v-for="(star, index) in stars.foodScore"
              :key="index"
              class="star-item"
              :class="star"
            >★</span>
        ...
        <div class="ratings-right__bottom">
          送达时间
      ...
      <ul>
        <li class="rating-item" v-for="(item, index) in ratings" :key="index" v-show="isShow">
          ...
          <div class="content">
            ...
            <div class="time">{{format[index]}}</div>
          </div>
        </li>
      </ul>
    </div>
...
export default {
      ...
      let rateTime = this.ratings.map(item => {
        ...
        if (timestr[1].slice(0, 1) === "上") {
          ...
          formatTime =
            timestr[0] +
            " " +
            (timestr[1].slice(2, 6).match(/\d+\.?/g)[0] * 1 + 12) +
            timestr[1].slice(3, 6);
        }
        return formatTime;
      });
  ...
  created() {
    this.$http.get("../../../static/rating.json").then(res => {
...
.score-container {
  ...
  .ratings-right {
    ...
    .ratings-right__top, .ratings-right__middle {
      margin-bottom: 8px;
      font-size: 0;
    }
